...
The estimates for the support for Biden in each state are shown in @fig-estimatedpropsupport. We followed and modified the code provided in Chapter 16 of "Telling Stories with Data" [@tswd] to produce @fig-estimatedpropsupport. We can see that the proportion of voters classified as Biden voters
