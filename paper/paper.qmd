...
date: today
date-format: long
abstract: "The 2024 U.S. Presidential Election will take place on November 5th and it will be a rematch between President Joe Biden and Former President Donald Trump. Using multi-level regression with post-stratification (MRP) we found that ... Based on our results, we can predict that Joe Biden will win 59% of the popular vote. "
format: pdf
...
#| tbl-cap: "Estimated Popular Vote"
biden_support_overall <- presidential_vote_model %>%
  ...
  ungroup() %>%
  summarise(
    "Lower Estimate" = quantile(support_biden_predict, 0.05),
    "Mean Estimate" = mean(support_biden_predict),
    "Upper Estimate" = quantile(support_biden_predict, 0.95)
  )
