...
We used R [@citeR], and the `tidyverse` [@citetidyverse], `janitor` [@citejanitor], `ggplot` [@citeggplot], `rstanarm` [@citerstanarm], and `arrow` [@citearrow] packages throughout our analtsis to clean our survey and post-stratification data sets, fit our model, apply our model, and create our data visualizations.
